...
var _user$project$Docker_Types$Node = F6(
	function (a, b, c, d, e, f) {
		return {id: a, name: b, role: c, status: d, managerStatus: e, info: f};
	});
...
var _user$project$Docker_Types$TaskStatus = F3(
	function (a, b, c) {
		return {timestamp: a, timestateInfo: b, state: c};
	});
var _user$project$Docker_Types$TaskInfo = F2(
	function (a, b) {
		return {cpu: a, memory: b};
	});
var _user$project$Docker_Types$Task = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, serviceId: b, nodeId: c, slot: d, status: e, desiredState: f, containerSpec: g, info: h};
	});
...
var _user$project$Docker_Types$AssignedTask = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, serviceId: b, nodeId: c, slot: d, status: e, desiredState: f, containerSpec: g, info: h};
	});
...
var _user$project$Docker_Types$Docker = F6(
	function (a, b, c, d, e, f) {
		return {nodes: a, networks: b, services: c, plannedTasks: d, assignedTasks: e, refreshTime: f};
	});
var _user$project$Docker_Types$DockerApiData = F5(
	function (a, b, c, d, e) {
		return {nodes: a, networks: b, services: c, tasks: d, refreshTime: e};
	});
...
var _user$project$Components_Networks$svgCircle = F4(
	function (_p0, rad, colour, name) {
		var _p1 = _p0;
		return A2(
...
var _user$project$Components_Networks$svgLine = F5(
	function (_p3, _p2, width, colour, name) {
		var _p4 = _p3;
		var _p5 = _p2;
		return A2(
...
var _user$project$Components_Networks$topLine = F3(
	function (i, color, name) {
		return A5(
...
var _user$project$Components_Networks$bottomLine = F3(
	function (i, color, name) {
		return A5(
			_user$project$Components_Networks$svgLine,
			{
...
var _user$project$Components_Networks$fullLine = F3(
	function (i, color, name) {
		return A5(
			_user$project$Components_Networks$svgLine,
			{
...
var _user$project$Components_Networks$tails = F3(
	function (connections, colors, names) {
		var symbol = F2(
			function (i, connection) {
				var name = A2(
					_elm_lang$core$Maybe$withDefault,
					'',
					A2(_elm_lang$core$Array$get, i, names));
				var color = A2(
					_elm_lang$core$Maybe$withDefault,
					'white',
				...
				return A2(
					...
					ctor: '::',
					_0: A3(_user$project$Components_Networks$fullLine, i, color, name),
					_1: {ctor: '[]'}
				} : {ctor: '[]'};
			});
		return A2(
...
var _user$project$Components_Networks$dot = F3(
	function (i, color, name) {
		return A4(
...
var _user$project$Components_Networks$attachments = F3(
	function (connections, colors, names) {
		var symbol = F2(
			function (i, connection) {
				var name = A2(
				...
				switch (_p7.ctor) {
					case 'Through':
						return {
							ctor: '::',
							_0: A3(_user$project$Components_Networks$topLine, i, color, name),
							_1: {
								ctor: '::',
								_0: A3(_user$project$Components_Networks$bottomLine, i, color, name),
								_1: {ctor: '[]'}
							}
						};
					case 'Start':
						return {
							ctor: '::',
							_0: A3(_user$project$Components_Networks$dot, i, color, name),
							_1: {
								ctor: '::',
								_0: A3(_user$project$Components_Networks$bottomLine, i, color, name),
								_1: {ctor: '[]'}
...
var _user$project$Components_Networks$tcap = F3(
	function (i, color, name) {
		return {
			ctor: '::',
			_0: A5(
...
var _user$project$Components_Networks$head = function (networks) {
	var cap = F2(
		function (i, network) {
			return network.ingress ? A3(_user$project$Components_Networks$tcap, i, 'white', network.name) : {ctor: '[]'};
		});
	return A2(
		_elm_lang$svg$Svg$svg,
		{
...
var _user$project$Components_Networks$connections = F2(
	function (service, networkConnections) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_user$project$Components_Networks$attachments, connections, colors, names),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: A3(_user$project$Components_Networks$tails, connections, colors, names),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Components$swarmHeader = F3(
	function (nodes, networks, refreshTime) {
		return A2(
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('refresh-time'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(refreshTime),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Components$task = F2(
	function (service, _p1) {
		var _p2 = _p1;
		var _p9 = _p2.status;
		var _p8 = _p2.info;
		var _p7 = _p2.desiredState;
		var timestateInfo = function () {
			var _p3 = _p9.timestateInfo;
			if (_p3.ctor === 'Just') {
				return {
					ctor: '::',
					_0: A2(
			...
			if (_p4.ctor === 'Just') {
				return {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('tag right'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
			...
			if (_p5.ctor === 'Just') {
				return {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('tag left'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
		...
		var classes = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _p9.state, _1: true},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'task', _1: true},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Basics_ops['++'], 'desired-', _p7),
						_1: true
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'running-old',
							_1: _elm_lang$core$Native_Utils.eq(_p9.state, 'running') && (!_elm_lang$core$Native_Utils.eq(service.containerSpec.image, _p2.containerSpec.image))
						},
						_1: {ctor: '[]'}
					}
				}
											...
											_0: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_user$project$Components$statusString, _p9.state, _p7)),
														_1: {ctor: '[]'}
													}
												}
											},
...
var _user$project$Components$serviceNode = F3(
	function (service, taskAllocations, node) {
		var forThisService = function (_p10) {
			var _p11 = _p10;
			return _elm_lang$core$Native_Utils.eq(_p11._1, service.id);
		};
		var tasksOfThisService = A2(
			_elm_lang$core$List$filter,
			forThisService,
			_elm_lang$core$Dict$keys(taskAllocations));
		var noTaskNowhere = _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(tasksOfThisService),
			0);
		var tasks = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(
				...
				taskAllocations));
		return noTaskNowhere ? A2(
			_elm_lang$html$Html$td,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('empty-service'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}) : A2(
			_elm_lang$html$Html$td,
...
var _user$project$Components$swarmGrid = F5(
	function (services, nodes, networks, taskAllocations, refreshTime) {
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_user$project$Components$swarmHeader, nodes, networks, refreshTime),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Docker_Json$taskInfo = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Docker_Types$TaskInfo,
...
var _user$project$Docker_Json$taskStatus = A4(
...
var _user$project$Docker_Json$nodeStatus = A3(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _user$project$Docker_Json$node = A7(
			...
			A2(
				...
				_elm_lang$core$Json_Decode$list(
					A2(
						...
						_elm_lang$core$Json_Decode$string))))));
var _user$project$Docker_Json$task = A9(
	...
	A2(
		...
		_user$project$Docker_Json$taskInfo));
var _user$project$Docker_Json$dockerApi = A6(
...
var _user$project$Docker$empty = A6(
...
var _user$project$Main$view = function (_p0) {
	...
	var refreshTime = _p2.refreshTime;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A5(_user$project$Components$swarmGrid, services, nodes, networks, _p1.tasks, refreshTime),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$ul,
...
var _user$project$Main$localWebsocket = function (location) {
	return _elm_lang$core$Native_Utils.eq(location.protocol, 'https:') ? A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			location.host,
			A2(_elm_lang$core$Basics_ops['++'], location.pathname, 'stream'))) : A2(
		_elm_lang$core$Basics_ops['++'],
		'ws://',
		A2(
			_elm_lang$core$Basics_ops['++'],
			location.host,
			A2(_elm_lang$core$Basics_ops['++'], location.pathname, 'stream')));
};
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {pathname: a, webSocketUrl: b, authToken: c, swarm: d, tasks: e, errors: f};
	});
var _user$project$Main$Receive = function (a) {
	return {ctor: 'Receive', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$String$isEmpty(model.authToken) ? _elm_lang$core$Platform_Sub$none : A2(
		_elm_lang$websocket$WebSocket$listen,
		A2(
			_elm_lang$core$Basics_ops['++'],
			model.webSocketUrl,
			A2(_elm_lang$core$Basics_ops['++'], '?authToken=', model.authToken)),
		_user$project$Main$Receive);
};
var _user$project$Main$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Main$AuthTokenReceived = function (a) {
	return {ctor: 'AuthTokenReceived', _0: a};
};
var _user$project$Main$authTokenGetter = function (pathname) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$AuthTokenReceived,
		_elm_lang$http$Http$getString(
			A2(_elm_lang$core$Basics_ops['++'], pathname, 'auth_token')));
};
var _user$project$Main$init = function (location) {
	return {
		...
		_1: _user$project$Main$authTokenGetter(location.pathname)
	};
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			case 'Receive':
				var _p5 = _user$project$Docker$fromJson(_p3._0);
				if (_p5.ctor === 'Ok') {
					var _p6 = _p5._0;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								swarm: _p6,
								tasks: A2(_user$project$Util$groupBy, _user$project$Docker_Types$taskIndexKey, _p6.assignedTasks)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p7 = _p5._0;
					return A2(_elm_lang$core$String$contains, 'WrongAuthToken', _p7) ? {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$authTokenGetter(model.pathname)
					} : {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
